...
import com.github.frostycityman.inlinesqlcommentor.sql.parser.generated.mysql.MySqlParser
import com.github.frostycityman.inlinesqlcommentor.sql.parser.generated.mysql.MySqlParserBaseVisitor

/**
 * SELECT 절의 각 컬럼 식별자를 수집하는 방문자(Visitor).
 * MySqlParser를 기준으로 했지만, PostgreSQL이나 Oracle도 유사하게 구현할 수 있습니다.
 */
class ColumnCommentVisitor : MySqlParserBaseVisitor<Unit>() {
     ...
     */
    override fun visitSelect_list(ctx: MySqlParser.Select_listContext) {
